...
export interface ApiComercioComercio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Poblacion: Schema.Attribute.DynamicZone<['herramientas.genero']>;
    publishedAt: Schema.Attribute.DateTime;
    Segmento: Schema.Attribute.DynamicZone<['herramientas.establecimientos']>;
    Social: Schema.Attribute.DynamicZone<['herramientas.redes']>;
    Tamano: Schema.Attribute.Enumeration<['Pequena', 'Mediana', 'Grande']>;
    Ubicaciones: Schema.Attribute.DynamicZone<['herramientas.direcciones']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiDivipolaDivipola extends Struct.CollectionTypeSchema {
  collectionName: 'divipolas';
  info: {
